...
class HomePostCell: UICollectionViewCell {
    ...
    let captionLabel: UILabel = {
        ...
        let attributedText = NSMutableAttributedString(string: "NightLife", attributes: [NSAttributedStringKey.font: UIFont.boldSystemFont(ofSize: 14)])
        attributedText.append(NSAttributedString(string: " Excitement of walking across the screen of the Asian country", attributes: [NSAttributedStringKey.font: UIFont.systemFont(ofSize: 14)]))
